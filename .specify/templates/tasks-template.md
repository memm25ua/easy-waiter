...
regressions, and cross-boundary behavior. Include the smallest reliable test
scope, plus integration or end-to-end tests when behavior crosses module,
service, persistence, or UI boundaries.
...
- [ ] T004 [P] Configure automated test command and coverage/reporting output
...
- [ ] T011 Configure performance measurement hooks or benchmark fixtures required by plan.md
...
- [ ] T014 [P] [US1] User experience state test for [loading/empty/error/success] in tests/[type]/test_[name].py
- [ ] T015 [P] [US1] Performance budget test for [metric] in tests/performance/test_[name].py
...
- [ ] T020 [US1] Add validation and error handling using established UX patterns
...
- [ ] T024 [P] [US2] Regression test for [business rule or prior behavior] in tests/[type]/test_[name].py
- [ ] T025 [P] [US2] Performance budget test for [metric] in tests/performance/test_[name].py
...
- [ ] T032 [P] [US3] User experience state test for [loading/empty/error/success] in tests/[type]/test_[name].py
...
- [ ] TXXX [P] Additional unit tests for uncovered rules in tests/unit/
- [ ] TXXX Security hardening
- [ ] TXXX Verify linting, formatting, static checks, and all automated tests pass
- [ ] TXXX Validate user experience consistency across affected journeys
...
Task: "Performance budget test for [metric] in tests/performance/test_[name].py"
...
- Verify performance budgets and UX states defined in plan.md
